...
buster.testCase("troopjs-contrib-browser/logger/service", function (run) {
	"use strict";

	var ARRAY_PUSH = Array.prototype.push;
	var assert = buster.referee.assert;

	require( [ "troopjs-contrib-browser/logger/service", "troopjs-core/component/gadget", "troopjs-core/pubsub/hub" ] , function (Service, Gadget, hub) {
