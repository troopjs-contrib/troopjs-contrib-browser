...
buster.testCase("troopjs-contrib-browser/logger/pubsub", function (run) {
	"use strict";
	...
	require( [ "troopjs-contrib-browser/logger/pubsub", "troopjs-core/pubsub/hub" ] , function (logger, hub) {
		run({
			"setUp" : function () {
